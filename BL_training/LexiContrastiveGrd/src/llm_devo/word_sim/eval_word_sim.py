...
def get_parser():
    ...
    parser.add_argument(
            '--eval_dir', default='data',type=str, action='store') # added by linda to support folders like strict and very_strict
    parser.add_argument(
...
class WordSimRunner(use_lm_eval.LMEvalRunner):
    ...
    def load_human_string_lists_sims(self):
        self.string_lists_sims = load_human_sim_data(data_folder=self.args.eval_dir)
