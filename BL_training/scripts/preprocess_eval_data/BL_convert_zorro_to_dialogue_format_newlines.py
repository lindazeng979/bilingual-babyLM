...
def convert_examples(in_file, speaker_label):
    ...
    out_file = in_file.replace('BL-data_zorro_OFFICIAL_20M',f'BL-data_zorro_OFFICIAL_20M_dialogue-format-BL_{speaker_label}')
...
in_path = '/Users/lindazeng/Documents/bilingual-llms/BL_training/evaluation-pipeline/BL-data_zorro_OFFICIAL_20M'
