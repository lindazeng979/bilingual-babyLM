...
export MODEL_SIZE=$6 #This is the specific arch you want to use within this type e.g. gpt2, gpt2-mini
...
# Added by Linda: Set W&B env vars before running 
#----------------------------------
RUN_NAME=$(basename "${MODEL_DIR}")
export WANDB_MODE=online
export WANDB_PROJECT=gpt2-training
export WANDB_TAGS="gpt2,${MODEL_SIZE},baseline"
export WANDB_NOTES="Training ${RUN_NAME} with LR=${LR}, seed=${SEED}"
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python3 scripts/language_model_training/examples/run_clm.py \
    ...
    --save_total_limit 2 \
	--logging_steps 10 \
    --report_to wandb         # added by Linda